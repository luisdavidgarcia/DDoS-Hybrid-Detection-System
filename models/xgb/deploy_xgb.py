...
logging.basicConfig(filename='/var/log/suricata/xgb_model_binary_predictions.log', level=logging.INFO, format='%(asctime)s - %(message)s')

# Load the Logistic Regression model (not Decision Tree)
xgb_model = joblib.load('/models/logistic_regression_binary_model.joblib')
